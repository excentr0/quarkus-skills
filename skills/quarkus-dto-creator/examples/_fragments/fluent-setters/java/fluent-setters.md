...
## Insert Point
As methods in the class body, after **all** getters (when fluent setters are chosen, getters are NOT
interleaved with setters — they form their own block first, then all fluent setters follow).
