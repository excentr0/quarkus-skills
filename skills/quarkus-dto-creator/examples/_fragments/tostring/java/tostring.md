...
## Insert Point
As a method in the class body, after equals/hashCode.

## Code

```defaults
// Default: generated (isToString=true by default).
// Format: the separator ", " is appended at the end of each non-last line,
...
- Continuation lines are indented one extra unit beyond `return`.
