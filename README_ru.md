...
| [`quarkus-opentelemetry-configuration`](skills/quarkus-opentelemetry-configuration/SKILL.md) | OpenTelemetry: трейсинг и метрики — extension, OTLP, `@WithSpan`/`Tracer` спаны, `Meter` метрики, Jaeger/LGTM Dev Service, InMemory-экспортёры для тестов. | Ready |
